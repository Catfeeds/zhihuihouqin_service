package cn.lc.model.easeui.init;
...
import cn.lc.model.easeui.domain.EaseEmojicon;
import cn.lc.model.easeui.domain.EaseEmojiconGroupEntity;
import cn.lc.model.easeui.domain.EaseUser;
import cn.lc.model.easeui.init.db.DemoDBManager;
import cn.lc.model.easeui.init.db.InviteMessgeDao;
import cn.lc.model.easeui.init.db.UserDao;
import cn.lc.model.easeui.init.domain.EmojiconExampleGroupData;
import cn.lc.model.easeui.init.domain.InviteMessage;
import cn.lc.model.easeui.init.domain.RobotUser;
import cn.lc.model.easeui.init.receiver.CallReceiver;
import cn.lc.model.easeui.init.utils.PreferenceManager;
import cn.lc.model.easeui.model.EaseNotifier;
import cn.lc.model.easeui.utils.EaseCommonUtils;
...
//    private M_UserInfoDao m_userInfoDao;
...
//                SearcePersonInfoBean user = m_userInfoDao.findBeanByHXName(message.getFrom().replace("m", ""));
//                if (user != null) {
////                    if(EaseAtMessageHelper.get().isAtMeMsg(message)){
////                        return String.format(appContext.getString(R.string.at_your_in_group), user.getNick());
////                    }
//                    return user.userName + ": " + ticker;
//                } else {
//                    if (EaseAtMessageHelper.get().isAtMeMsg(message)) {
