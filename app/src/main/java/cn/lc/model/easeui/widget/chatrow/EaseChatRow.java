package cn.lc.model.easeui.widget.chatrow;
...
import cn.lc.model.easeui.adapter.EaseMessageAdapter;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if (message.direct() == Direct.SEND) {
            LogUtil.log(EMClient.getInstance().getCurrentUser() + "=============聊天界面  我的头像=================");
//            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser().replace("u" , ""), userAvatarView);
            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
        } else {
            LogUtil.log(message.getFrom() + "=============聊天界面  非我的头像=================");
//            EaseUserUtils.setUserAvatar(context, message.getFrom().replace("m" , ""), userAvatarView);
