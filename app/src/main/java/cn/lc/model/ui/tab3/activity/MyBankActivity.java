...
public class MyBankActivity extends MvpSimpleActivity<MyBankView,MyBankPresenter> implements MyBankView {
   @BindView(R.id.iv_back)
    ...
    private MyBankAdapter myAdpater;
    @Override
    public void setContentLayout() {
        setContentView(R.layout.activity_mybank1);
...
public void onClick(View view){
    ...
    public void initView() {
        ...
        myAdpater = new MyBankAdapter(list, getActivity());
