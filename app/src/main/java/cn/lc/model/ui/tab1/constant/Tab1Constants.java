...
public class Tab1Constants {
    ...
    public static final int WORK_RECEIVED_ORDER = 1;
    public static final int WORK_DELIVERY = 2;
    public static final int WORK_FINISH = 3;
    public static final int WORK_CANCEL = 5;
    // 订水服务
    public static final int WATER_UNRECEIVE_ORDER = 0;
    public static final int WATER_RECEIVED_ORDER = 1;
    ...
    public static final int MEETINGROOM_CANCEL = 5;
